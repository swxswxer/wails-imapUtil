<template>
  <div class="export-container">
    <el-card title="导出配置" class="export-card">
      <el-form :model="exportForm" ref="formRef" label-width="100px">
        <el-form-item label="导出字段">
          <el-checkbox-group v-model="exportForm.fields">
            <el-checkbox label="subject">主题</el-checkbox>
            <el-checkbox label="from">发件人</el-checkbox>
            <el-checkbox label="to">收件人</el-checkbox>
      ...
      <div class="export-result" v-if="exportStatus === 'success'">
        <el-alert
          title="导出成功"
          type="success"
          description="Excel 文件已成功导出到您的设备"
          show-icon
        />
        <el-button type="primary" @click="goBack" style="margin-top: 20px">返回搜索</el-button>
      </div>
...
const exportToExcel = async () => {
  ...
  try {
    ...
    await exportService.exportToExcel(emails.value, exportForm.fields, exportForm.fileName)
...
onMounted(() => {
  ...
  exportForm.fields = exportStore.exportFields
